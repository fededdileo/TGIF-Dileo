...
let stats = {};
let memberList = dataHouse.results[0].members
let url = window.location.pathname.split("/").pop();

function init(members) {
  if (url.split("-").pop() === "att.html") {
    generatePartyLists(members);
    setStats();
    printDataAtGlance(members);
    generateLeastAndMost(members, "least", "descending", "missed_votes_pct", fieldsAttendance);
    generateLeastAndMost(members, "most", "ascending", "missed_votes_pct", fieldsAttendance);
  } else if (url.split("-").pop() === "loyalty.html") {
    generatePartyLists(members);
    setStats();
    printDataAtGlance(members);
    generateLeastAndMost(members, "least", "ascending", "votes_with_party_pct", fieldsLoyalty);
...
init(dataHouse.results[0].members)